<?php
define('BOT_TOKEN', '416952197:AAF7JmZ_xSLfMOyJK-7FGtgxdBZMMC1AwjE');
    ...
    if (isset($message['photo'])) {
        ...
        if ( $chat_id != $admin1&&$chat_id != $admin2) {
            ...
            if (!in_array($chat_id,$membersid)) {
                apiRequest("forwardMessage", array('chat_id' => $admin1,  "from_chat_id"=> $chat_id ,"message_id" => $message_id));
                apiRequest("forwardMessage", array('chat_id' => $admin2,  "from_chat_id"=> $chat_id ,"message_id" => $message_id));
...
لطفا پیام ندهید🖕" ,"parse_mode" =>"HTML"));
        ...
        }  else if (($chat_id == $admin1||$chat_id==$admin2) && $booleans[0] == "true") {
...
لطفا پیام ندهید🖕" ,"parse_mode" =>"HTML"));
        ...
        else if (($chat_id == $admin||$chat_id==$admin2) && $booleans[0] == "true") {
            $sticker = $message['sticker']['file_id'];
            $ttxtt = file_get_contents('pmembers.txt');
            $membersidd= explode("\n",$ttxtt);
            for($y=0;$y<count($membersidd);$y++){
...
.',"parse_mode"=>"MARKDOWN", 'reply_markup' => array(
        ...
        } else if ($matches[0] == "/setstart" && ($chat_id==$admin1||$chat_id==$admin2)) {
...
."));
        ...
        else if ($matches[0] == "/setdone" && ($chat_id==$admin1||$chat_id==$admin2)) {
...
."));
        ...
        else if ($text != "" && ($chat_id!=$admin1&&$chat_id!=$admin2)) {
...
لطفا پیام ندهید🖕" ,"parse_mode" =>"HTML"));
        ...
        }else if ($text == "تنظیمات⚙" && ($chat_id==$admin1||$chat_id==$admin2)) {
...
.', 'reply_markup' => array(
        ...
        }else if ($text == "راهنما📜" && ($chat_id==$admin1||$chat_id==$admin2)) {

            apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "`برای پاسخ پیام مورد نظر را ریپلای کنید`
...
.","parse_mode" =>"MARKDOWN",'reply_markup' => array(
        ...
        }else if ($text == "پاک کردن تمام اعضا❌" && ($chat_id==$admin1||$chat_id==$admin2)) {
...
.', 'reply_markup' => array(
        ...
        else if ($text == "پاک کردن تمام مسدود شده ها❌" && ($chat_id==$admin1||$chat_id==$admin2)) {
        ...
        else if ($text == "برگشت" && ($chat_id==$admin1||$chat_id==$admin2)) {
...
.', 'reply_markup' => array(
        ...
        else if ($text =="ارسال پیام به همه🛰"  && ($chat_id==$admin1||$chat_id==$admin2) && $booleans[0]=="false") {
...
.","parse_mode" =>"HTML",'reply_markup' => array(
            ...
            $addd = "false";
            file_put_contents('booleans.txt',$addd);
        }else if($text == "اعضا👥" && ($chat_id==$admin1||$chat_id==$admin2) ){
        ...
        }else if($text == "مسدود شده ها🚫" && ($chat_id==$admin1||$chat_id==$admin2) ){
